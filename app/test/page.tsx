...
const content = [
  {
    ...
    lowExampleUrl: `http://localhost:3000/contact`,
    ...
    highExampleUrl: `http://localhost:3000/contact`,
    icon: Icon1,
  },
  {
  ...
  return (
    <div className="container flex flex-col items-center justify-center">
      <Reveal direction="top">
        <h2 className="text-4xl mt-5 text-transparent bg-clip-text bg-gradient-to-br from-purple-600 to-blue-500 mb-4">
